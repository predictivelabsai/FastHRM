...
COPY = {
    "et": {
        ...
        "cmp2_note": "FastHR-i hind on näidatud viimases reas. Teiste platvormide hinnad sõltuvad päringust. Andmed pärinevad avalikest allikatest (sept 2026).",
        ...
        "cmp_global_note": "Võrdlus põhineb iga platvormi kohta toodud ametlikel allikatel. FastHR-i hind on näidatud viimases reas; teiste platvormide hinnad sõltuvad päringust.",
    ...
    "en": {
        ...
        "cmp2_note": "FastHR pricing appears in the final row. Other platforms use inquiry-based pricing. Competitor data comes from public sources (Sep 2026).",
        ...
        "cmp_global_note": "Comparison based on the official sources linked for each platform. FastHR pricing appears in the final row; other platforms use inquiry-based pricing.",
