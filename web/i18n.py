...
COPY = {
    "et": {
        ...
        "cmp2_prices": ["Tasuta · 1 € kuus inimese kohta", "Päringu alusel", "Päringu alusel", "Päringu alusel", "Päringu alusel", "Päringu alusel"],
        "cmp2_legend": [("yes", "Olemas"), ("soon", "Tulekul"), ("no", "Puudub")],
        "cmp2_note": "Konkurentide hinnad on päringu või müügikõne taga. Näidatud on FastHR-i hind. Andmed pärinevad avalikest allikatest (sept 2026).",
        ...
        "cmp_pg_meta_desc": "Võrdle FastHR-i Gusto, BambooHR, Rippling, Deel, Zoho People "
                            "ja Odoo HR-iga hinna, litsentsi, palga ja ulatuse osas.",
        "cmp_pg_eyebrow": "Kuidas me võrdleme",
        "cmp_pg_h1": "Vaikimisi vaba ja avatud.",
        "cmp_pg_lede": "Allikatega võrdlus FastHR-ist ja kuuest lähedasest alternatiivist. "
                       "Tarkvara hind, avatus ja käituskulud on eraldi näidatud.",
        ...
        "cmp_pg_caption": "Avalik hind ja litsents seisuga sept 2026. FastHR-i hind on näidatud. "
                          "Konkurentide hindu ei ole lisatud, sest need sõltuvad päringust või müügiprotsessist.",
        "cmp_pg_source": "Ametlik allikas ↗",
        "cmp_pg_license": "Litsents ↗",
        "cmp_pg_table_label": "HR-platvormide võrdlus",
        "cmp_pg_price_values": {"Gusto": "$49 kuus + $6 inimese kohta", "BambooHR": "Põhipakett alates $10 töötaja kohta kuus", "Rippling": "Alates $8 kasutaja kohta kuus + $40 baastasu", "Deel": "$49 töövõtja või $599 EOR töötaja kohta kuus", "Zoho People": "5 kasutajale tasuta; tasuline alates $1,25 kasutaja kohta kuus aastamaksega", "Odoo HR": "One App Free; kõik rakendused alates $24,90 kasutaja kohta kuus aastamaksega"},
        ...
        "cmp_pg_note": "Võrdlus põhineb ametlikel müüjalehtedel, millele iga rida viitab. "
        ...
        "comparison_estonia": [
            {"name": "FastHR", "best_for": "Väikeettevõtetele ja idufirmadele, kes soovivad laia HR- ja värbamistarkvara ilma litsentsitasuta", "team": "Väikesed ja kasvavad tiimid", "price": "Tasuta, kõik loetletud funktsioonid", "free_option": "Kõik saadaolevad funktsioonid", "source_model": "Jah · MIT", "source_class": "open", "payroll_global": "Palgapäevad ja palgalehed koos rea-põhise jaotusega; vahetuste planeerimine, asukohateadlik tööaja registreerimine ja automaatne kohalolek; kuluhüvitised, ettemaksed ja lähetustaotlused; töötaja iseteenindusportaal.", "limits": "Granulaarse RBAC-i tugevdamine ja aktiivsed teenuseühendused on teekaardil. Sügavam seadusjärgne palk, sealhulgas TÖR-i ja TSD ekspordid ning puhkuse- ja töövõimetustasu arvestus, on samuti teekaardil.", "source": "https://github.com/predictivelabsai/FastHRM", "highlight": True},
            {"name": "Persona", "best_for": "Eesti ettevõtetele, kes vajavad personalitöö ja palga tööriistu", "team": "Avalik info puudub.", "price": "Päringu- või müügipõhine", "free_option": "Hinnakiri pole avalik.", "source_model": "Ei", "source_class": "closed", "payroll_global": "Eesti palgaarvestus: olemasolev võrdlus märgib selle olemasolevaks", "limits": "Värbamine, tulemusjuhtimine ja avalik API pole olemasolevas võrdluses märgitud", "source": "https://persona.ee/", "highlight": False},
            {"name": "Wemply", "best_for": "Eesti ettevõtetele, kes vajavad personalitöö ja palga tööriistu", "team": "Avalik info puudub.", "price": "Päringu- või müügipõhine", "free_option": "Hinnakiri pole avalik.", "source_model": "Ei", "source_class": "closed", "payroll_global": "Eesti palgaarvestus: olemasolev võrdlus märgib selle olemasolevaks", "limits": "Värbamine ja tulemusjuhtimine pole olemasolevas võrdluses märgitud", "source": "https://wemply.com/", "highlight": False},
            {"name": "HRM4Baltics", "best_for": "Eesti ettevõtetele, kes vajavad personalitöö ja palga tööriistu", "team": "Avalik info puudub.", "price": "Päringu- või müügipõhine", "free_option": "Hinnakiri pole avalik.", "source_model": "Ei", "source_class": "closed", "payroll_global": "Eesti palgaarvestus: olemasolev võrdlus märgib selle olemasolevaks", "limits": "Värbamine ja tulemusjuhtimine pole olemasolevas võrdluses märgitud", "source": "https://hrm4baltics.com/", "highlight": False},
            {"name": "hours24", "best_for": "Eesti ettevõtetele, kes vajavad personalitöö ja tööaja tööriistu", "team": "Avalik info puudub.", "price": "Päringu- või müügipõhine", "free_option": "Hinnakiri pole avalik.", "source_model": "Ei", "source_class": "closed", "payroll_global": "Eesti palgaarvestus: olemasolev võrdlus märgib selle olemasolevaks", "limits": "Värbamine ja tulemusjuhtimine pole olemasolevas võrdluses märgitud", "source": "https://hours24.com/", "highlight": False},
            {"name": "Yester", "best_for": "Eesti ettevõtetele, kes vajavad personalitöö tööriistu", "team": "Avalik info puudub.", "price": "Päringu- või müügipõhine", "free_option": "Hinnakiri pole avalik.", "source_model": "Ei", "source_class": "closed", "payroll_global": "Eesti palgaarvestus: võrdlus ei märgi seda olemasolevaks", "limits": "Tööaeg, Eesti palk, värbamine, tulemusjuhtimine ja avalik API pole olemasolevas võrdluses märgitud", "source": "https://yester.eu/", "highlight": False},
        ],
        "comparisons": [
            {"name": "FastHR", "best_for": "Väikeettevõtetele ja idufirmadele, kes soovivad laia HR- ja värbamistarkvara ilma litsentsitasuta", "team": "Väikesed ja kasvavad tiimid", "price": "Tasuta, kõik loetletud funktsioonid", "price_class": "free", "free_option": "Kõik saadaolevad funktsioonid", "source_model": "Jah · MIT", "source_class": "open", "payroll_global": "Palgapäevad ja palgalehed koos rea-põhise jaotusega; vahetuste planeerimine, asukohateadlik tööaja registreerimine ja automaatne kohalolek; kuluhüvitised, ettemaksed ja lähetustaotlused; töötaja iseteenindusportaal.", "limits": "Granulaarse RBAC-i tugevdamine ja aktiivsed teenuseühendused on teekaardil. Sügavam seadusjärgne palk, sealhulgas TÖR-i ja TSD ekspordid ning puhkuse- ja töövõimetustasu arvestus, on samuti teekaardil.", "source": "https://github.com/predictivelabsai/FastHRM", "highlight": True},
            {"name": "Gusto", "best_for": "USA idufirmadele, kes seavad esikohale täisteenuse palga, maksud ja hüved", "team": "Tavaliselt 1–50", "price": "", "price_class": "closed", "free_option": "Püsivat tasuta paketti pole", "source_model": "Avalikku avatud lähtekoodiga väljaannet pole", "source_class": "closed", "payroll_global": "Tugev USA palgaarvestus; rahvusvahelised töövõtjate maksed on lisateenus", "limits": "Peamiselt USA-keskne; põhjalikum HR vajab kallimat paketti", "source": "https://gusto.com/product/pricing", "highlight": False},
            {"name": "BambooHR", "best_for": "Kasvavatele tiimidele, kes soovivad viimistletud põhi-HR-i", "team": "Tavaliselt 10–200", "price": "", "price_class": "closed", "free_option": "Prooviperiood; püsivat tasuta paketti pole", "source_model": "Ei · suletud lähtekoodiga", "source_class": "closed", "payroll_global": "Palk ja hüved on eraldi tellitavad teenused; rahvusvaheline ulatus on piiratud", "limits": "Hind sõltub töötajate arvust; lisavõimalused ja teenused tõstavad kogukulu", "source": "https://www.bamboohr.com/pricing/", "highlight": False},
            {"name": "Rippling", "best_for": "Kiiresti kasvavatele tiimidele, kes ühendavad HR-i, IT, seadmed, rakendused ja palga", "team": "Tavaliselt 20–500+", "price": "", "price_class": "closed", "free_option": "Demo ja kohandatud pakkumine", "source_model": "Avalikku avatud lähtekoodiga väljaannet pole", "source_class": "closed", "payroll_global": "USA ja rahvusvahelise palga võimalused ning põhjalik tööjõu automatiseerimine", "limits": "Platvormi kohustuslik tasu ja lisamoodulid võivad hinda ning juurutusvaeva kasvatada", "source": "https://www.rippling.com/solutions/small-businesses", "highlight": False},
            {"name": "Deel", "best_for": "Hajustiimidele, kes palkavad töötajaid ja töövõtjaid eri riikides", "team": "Igas suuruses, rahvusvahelise fookusega", "price": "", "price_class": "closed", "free_option": "Tasuta demo; üldist tasuta paketti pole", "source_model": "Avalikku avatud lähtekoodiga väljaannet pole", "source_class": "closed", "payroll_global": "EOR, töövõtjad ja palgaarvestus enam kui 130 riigis", "limits": "EOR-i ja töövõtjate nõuetele vastavuse tasud kasvavad; põhi-HR pole peamine tugevus", "source": "https://www.deel.com/pricing/", "highlight": False},
            {"name": "Zoho People", "best_for": "Hinnatundlikele väikestele ja keskmise suurusega ettevõtetele ning olemasolevatele Zoho klientidele", "team": "5–200+", "price": "", "price_class": "mixed", "free_option": "Püsiv tasuta pakett 5 kasutajale", "source_model": "Avalikku avatud lähtekoodiga väljaannet pole", "source_class": "closed", "payroll_global": "Mitmekeelne HR; palk on eraldi Zoho toode", "limits": "Põhjalikum kohaloleku-, tulemus- ja talendihaldus on kallimates pakettides", "source": "https://www.zoho.com/people/zohopeople-pricing.html", "highlight": False},
            {"name": "Odoo HR", "best_for": "Tiimidele, kes soovivad moodulipõhist HR-i suurema ERP-komplekti sees", "team": "Väike kuni keskmine ettevõte", "price": "", "price_class": "mixed", "free_option": "One App Free ja Community väljaanne", "source_model": "Community: LGPLv3; Enterprise: suletud", "source_class": "mixed", "payroll_global": "Lai moodulipõhine HR/ERP koos piirkondliku seadistusega", "limits": "Täielik HR-lahendus koosneb mitmest rakendusest; API ja kohandamine vajavad tasulist Custom paketti", "source": "https://www.odoo.com/pricing", "license_source": "https://www.odoo.com/documentation/18.0/legal/licenses.html", "highlight": False},
        ],
        "comparison_faqs": [
    ...
    "en": {
        ...
        "cmp_sub": "An honest, sourced comparison against Estonian and international "
                   "HR tools.",
        ...
        "cmp2_prices": ["Free · €1 per person per month", "Quote-based", "Quote-based", "Quote-based", "Quote-based", "Quote-based"],
        "cmp2_legend": [("yes", "Included"), ("soon", "Coming soon"), ("no", "Not available")],
        "cmp2_note": "Competitor pricing is inquiry-based or gated, so it is not listed here. FastHR pricing is shown. Competitor data comes from public sources (Sep 2026).",
        ...
        "cmp_pg_meta_desc": "Compare FastHR with Gusto, BambooHR, Rippling, Deel, Zoho "
                            "People, and Odoo HR across price, source model, payroll, and scope.",
        "cmp_pg_eyebrow": "How we compare",
        "cmp_pg_h1": "Free and open by default.",
        "cmp_pg_lede": "A source-linked comparison of FastHR with six close alternatives. "
                       "Software price, source availability and operating costs are shown "
                       "separately.",
        ...
        "cmp_pg_caption": "Public pricing and licensing observed Sep 2026. FastHR pricing is shown. "
                          "Competitor prices are omitted because they depend on an enquiry or sales process.",
        "cmp_pg_source": "Official source ↗",
        "cmp_pg_license": "Licence ↗",
        "cmp_pg_table_label": "HR platform comparison",
        "cmp_pg_price_values": {"Gusto": "$49/month + $6/person", "BambooHR": "Core from $10/employee/month", "Rippling": "From $8/user/month + $40 base fee", "Deel": "$49/contractor or $599/EOR employee monthly", "Zoho People": "Free for 5 users; paid from $1.25/user/month annually", "Odoo HR": "One App Free; all-app plans from $24.90/user/month annually"},
        ...
        "cmp_pg_legend": [("yes", "Open source"),
                          ...
                          ("no", "Closed source")],
        "cmp_pg_note": "Comparison is based on official vendor pages linked in each row. "
        ...
        "comparison_estonia": [
            {"name": "FastHR", "best_for": "SMEs and startups wanting broad HR, Estonian statutory payroll and recruiting without licence fees", "team": "Small and growing teams", "price": "Free, every listed feature", "free_option": "All available features", "source_model": "Yes · MIT", "source_class": "open", "payroll_global": "Pay runs and payslips with line-item breakdowns; shift scheduling, location-aware time-clock check-in and automatic attendance; expense claims, advances and travel requests; employee self-service portal.", "limits": "Granular RBAC hardening and live provider adapters remain on the roadmap. Deeper statutory payroll, including TÖR and TSD exports plus holiday and incapacity pay calculations, also remains on the roadmap.", "source": "https://github.com/predictivelabsai/FastHRM", "highlight": True},
            {"name": "Persona", "best_for": "Estonian organisations needing HR and payroll tools", "team": "No public information.", "price": "Inquiry-based or quote-based", "free_option": "Price list is not public.", "source_model": "No", "source_class": "closed", "payroll_global": "Estonian payroll: marked available in the existing comparison", "limits": "Recruiting, performance and public API are not marked available in the existing comparison", "source": "https://persona.ee/", "highlight": False},
            {"name": "Wemply", "best_for": "Estonian organisations needing HR and payroll tools", "team": "No public information.", "price": "Inquiry-based or quote-based", "free_option": "Price list is not public.", "source_model": "No", "source_class": "closed", "payroll_global": "Estonian payroll: marked available in the existing comparison", "limits": "Recruiting and performance are not marked available in the existing comparison", "source": "https://wemply.com/", "highlight": False},
            {"name": "HRM4Baltics", "best_for": "Estonian organisations needing HR and payroll tools", "team": "No public information.", "price": "Inquiry-based or quote-based", "free_option": "Price list is not public.", "source_model": "No", "source_class": "closed", "payroll_global": "Estonian payroll: marked available in the existing comparison", "limits": "Recruiting and performance are not marked available in the existing comparison", "source": "https://hrm4baltics.com/", "highlight": False},
            {"name": "hours24", "best_for": "Estonian organisations needing HR and time tools", "team": "No public information.", "price": "Inquiry-based or quote-based", "free_option": "Price list is not public.", "source_model": "No", "source_class": "closed", "payroll_global": "Estonian payroll: marked available in the existing comparison", "limits": "Recruiting and performance are not marked available in the existing comparison", "source": "https://hours24.com/", "highlight": False},
            {"name": "Yester", "best_for": "Estonian organisations needing HR tools", "team": "No public information.", "price": "Inquiry-based or quote-based", "free_option": "Price list is not public.", "source_model": "No", "source_class": "closed", "payroll_global": "Estonian payroll is not marked available in the existing comparison", "limits": "Time, payroll, recruiting, performance and public API are not marked available in the existing comparison", "source": "https://yester.eu/", "highlight": False},
        ],
        "comparisons": [
            {"name": "FastHR", "best_for": "SMEs and startups wanting broad HR, Estonian statutory payroll and recruiting without licence fees", "team": "Small and growing teams", "price": "Free, every listed feature", "price_class": "free", "free_option": "All available features", "source_model": "Yes · MIT", "source_class": "open", "payroll_global": "Pay runs and payslips with line-item breakdowns; shift scheduling, location-aware time-clock check-in and automatic attendance; expense claims, advances and travel requests; employee self-service portal.", "limits": "Granular RBAC hardening and live provider adapters remain on the roadmap. Deeper statutory payroll, including TÖR and TSD exports plus holiday and incapacity pay calculations, also remains on the roadmap.", "source": "https://github.com/predictivelabsai/FastHRM", "highlight": True},
            {"name": "Gusto", "best_for": "US startups prioritising full-service payroll, tax and benefits", "team": "Typically 1-50", "price": "", "price_class": "closed", "free_option": "No permanent free plan", "source_model": "No public open-source edition", "source_class": "closed", "payroll_global": "Strong US payroll; international contractor payments are an add-on", "limits": "Primarily US-focused; deeper HR features require higher plans", "source": "https://gusto.com/product/pricing", "highlight": False},
            {"name": "BambooHR", "best_for": "Growing teams wanting a polished, dedicated core HRIS", "team": "Typically 10-200", "price": "", "price_class": "closed", "free_option": "Trial; no permanent free plan", "source_model": "No · proprietary", "source_class": "closed", "payroll_global": "Payroll and benefits are subscribed services; limited global employment scope", "limits": "Per-employee pricing; advanced capabilities and services increase total cost", "source": "https://www.bamboohr.com/pricing/", "highlight": False},
            {"name": "Rippling", "best_for": "Fast-scaling teams combining HR, IT, devices, apps and payroll", "team": "Typically 20-500+", "price": "", "price_class": "closed", "free_option": "Demo and custom quote", "source_model": "No public open-source edition", "source_class": "closed", "payroll_global": "US and global payroll options with deep workforce automation", "limits": "Required platform plus modular products can raise cost and setup effort", "source": "https://www.rippling.com/solutions/small-businesses", "highlight": False},
            {"name": "Deel", "best_for": "Distributed teams hiring employees and contractors internationally", "team": "Any size; global-first", "price": "", "price_class": "closed", "free_option": "Free demo; no general free plan", "source_model": "No public open-source edition", "source_class": "closed", "payroll_global": "EOR, contractors and payroll across 130+ countries", "limits": "EOR and contractor compliance fees add up; core HR is not the main differentiator", "source": "https://www.deel.com/pricing/", "highlight": False},
            {"name": "Zoho People", "best_for": "Budget-conscious SMEs and existing Zoho customers", "team": "5-200+", "price": "", "price_class": "mixed", "free_option": "Permanent free plan for 5 users", "source_model": "No public open-source edition", "source_class": "closed", "payroll_global": "Multi-language HR; payroll is a separate Zoho product", "limits": "Advanced attendance, performance and talent features sit in higher tiers", "source": "https://www.zoho.com/people/zohopeople-pricing.html", "highlight": False},
            {"name": "Odoo HR", "best_for": "Teams wanting modular HR inside a broader ERP suite", "team": "Small to mid-market", "price": "", "price_class": "mixed", "free_option": "One App Free and Community edition", "source_model": "Community: LGPLv3; Enterprise: proprietary", "source_class": "mixed", "payroll_global": "Broad modular HR/ERP with regional configuration", "limits": "A complete HR stack spans multiple apps; API/customisation require the paid Custom plan", "source": "https://www.odoo.com/pricing", "license_source": "https://www.odoo.com/documentation/18.0/legal/licenses.html", "highlight": False},
        ],
        "comparison_faqs": [
