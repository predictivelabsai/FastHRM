...
COPY = {
    "et": {
        ...
        "cmp_global_note": "Võrdlus põhineb iga platvormi kohta toodud ametlikel allikatel. FastHR-i hind on näidatud viimases reas.",
        ...
        "cmp_pg_meta_desc": "Võrdle FastHR-i Gusto, BambooHR, Rippling, Deel, Zoho People "
                            "ja Odoo HR-iga litsentsi, palga ja ulatuse osas.",
        ...
        "comparison_estonia": [
            {"name": "FastHR", "source": "https://github.com/predictivelabsai/FastHRM", "highlight": True},
            {"name": "Persona", "source": "https://persona.ee/", "highlight": False},
            {"name": "Wemply", "source": "https://wemply.com/", "highlight": False},
            {"name": "HRM4Baltics", "source": "https://hrm4baltics.com/", "highlight": False},
            {"name": "hours24", "source": "https://hours24.com/", "highlight": False},
            {"name": "Yester", "source": "https://yester.eu/", "highlight": False},
        ],
        "comparisons": [
            {"name": "FastHR", "source": "https://github.com/predictivelabsai/FastHRM", "highlight": True},
            {"name": "Gusto", "source": "https://gusto.com/product/pricing", "highlight": False},
            {"name": "BambooHR", "source": "https://www.bamboohr.com/pricing/", "highlight": False},
            {"name": "Rippling", "source": "https://www.rippling.com/solutions/small-businesses", "highlight": False},
            {"name": "Deel", "source": "https://www.deel.com/pricing/", "highlight": False},
            {"name": "Zoho People", "source": "https://www.zoho.com/people/zohopeople-pricing.html", "highlight": False},
            {"name": "Odoo HR", "source": "https://www.odoo.com/pricing", "license_source": "https://www.odoo.com/documentation/18.0/legal/licenses.html", "highlight": False},
        ],
        "comparison_faqs": [
    ...
    "en": {
        ...
        "cmp_global_note": "Comparison based on the official sources linked for each platform. FastHR pricing appears in the final row.",
        ...
        "cmp_pg_meta_desc": "Compare FastHR with Gusto, BambooHR, Rippling, Deel, Zoho "
                            "People, and Odoo HR across source model, payroll, and scope.",
