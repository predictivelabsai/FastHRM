...
FEATURE_CATALOG = (
    ...
    ("Workforce planning", "Budgeted positions, scenarios and approval-led headcount planning.", "/workforce", True),
...
CMP_ROWS = (
    ...
    ("benefits",    ("yes", "no",  "no",  "no",  "no",  "no")),
    ("selfservice", ("yes", "yes", "yes", "yes", "yes", "yes")),
    ("ats",         ("yes", "no",  "no",  "no",  "no",  "no")),
    ("perf",        ("yes", "no",  "no",  "no",  "no",  "no")),
    ("learning",    ("yes", "no",  "no",  "yes", "no",  "no")),
    ("workforce",   ("yes", "no",  "no",  "no",  "no",  "no")),
...
GLOBAL_ROW_STATES = {
    ...
    "learning": ("yes", "no", "no", "yes", "no", "yes", "no"),
    "workforce": ("yes", "no", "no", "yes", "no", "no", "no"),
